...
import { getEmployersUpdate } from '../../../store/actions/userAction';
...
export default function EmployerUpdate() {
    ...
    const employerList = updateEmployers ? (
        updateEmployers.map((employer) => (
        <tr key={employer.id}>
            ...
            <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{employer.email}</td>
