...
import { getEmployersPassive } from '../../../store/actions/userAction';

export default function EmployerPassive() {


  const dispatch = useDispatch();

  const {passiveEmployers} = useSelector(state => state.users)

  useEffect(() => {
    dispatch(getEmployersPassive())
  },[])

  const employerList = passiveEmployers.length ? (
    passiveEmployers.map((employer) => (
      <tr key={employer.id}>
