...
import { getEmployersActive } from '../../../store/actions/userAction';

export default function EmployerActive() {

    const dispatch = useDispatch();

    const {activeEmployers} = useSelector(state => state.users)

    useEffect(() => {
      dispatch(getEmployersActive())
    },[])

    const employerList = activeEmployers.length ? (
