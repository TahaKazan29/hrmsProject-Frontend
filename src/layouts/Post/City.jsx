...
import { addCityToFilter } from '../../store/actions/postActions';
...
export default function City() {
    ...
    const handleCityChange = (e) => {
        dispatch(addCityToFilter(e.target.value))
        ...
        <>
            <div className="pt-16">
                    <div className="relative min-w-0 break-words bg-white mb-8 shadow-lg rounded">
                        ...
                        Şehir  {currentCityCount != 0 ? <span className="text-sm text-emerald-500">seçili ({currentCityCount})</span> : null}
                        </h6>
